...
import { createTemplate, deleteTemplates, getForms, getMetaData, getTemplate, getUserData, publishComment, updateTemplate } from "../controllers/templates.controller.js";
...
templatesRouter.get('/:templateId/forms', getForms)
// templatesRouter.get('/:templateId/comments', getComments)
